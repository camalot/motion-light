...
//<<constructor>>
WemoResponder::WemoResponder(){
    
}
 
//<<destructor>>
WemoResponder::~WemoResponder(){/*nothing to destruct*/}
 
bool WemoResponder::beginUdpMulticast(){
  boolean state = false;
...
void WemoResponder::addDevice(Switch& device) {
